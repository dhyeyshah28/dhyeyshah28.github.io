...
real-time sensor data from noisy IMU and stereo features to enable robust tracking with a local planner in obstacle-rich environments achieving reliable, collision-free navigation in simulation and hardware testing.
