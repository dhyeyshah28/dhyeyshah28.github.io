...
using ToF sensing, and target-attacking capabilities using a custom control architecture. Implemented real-time WiFi control and developed robust
mechatronic systems, to achieve precise ramp traversal and combat functionality.
